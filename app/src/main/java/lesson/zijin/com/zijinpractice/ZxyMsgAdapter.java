...
public class ZxyMsgAdapter extends ArrayAdapter<ZxyMsg>{
    private  int resource;

    public ZxyMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<ZxyMsg> objects) {
