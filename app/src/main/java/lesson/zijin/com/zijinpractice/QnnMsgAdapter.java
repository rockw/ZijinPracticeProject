...
/**
 * Created by qnn on 2017/3/26.
 */

public class QnnMsgAdapter extends ArrayAdapter<QnnMsg>{
    private  int resource;

    public QnnMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<QnnMsg> objects) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        if (msg.getType()== QnnMsg.TYPE_RECEIVER)//如果它是接收消息 就放左边
        {
            //显示左边 隐藏右边
