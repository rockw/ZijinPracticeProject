...
public class YrMsgAdapter extends ArrayAdapter<YrMsg> {
    private  int resource;

    public YrMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<YrMsg> objects) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        if (msg.getType()== YrMsg.TYPE_RECEIVER)//如果它是接收消息 就放左边
        {
            //显示左边 隐藏右边
