...
public class MsgAdapter_04 extends ArrayAdapter<Msg_04>
{
    private int resourceId;
    public MsgAdapter_04(Context context, int textViewResourceId, List<Msg_04> objects)
    {
