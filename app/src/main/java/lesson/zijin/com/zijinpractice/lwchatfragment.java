...
public class cylchatfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_lw6123,container,false);
        findView();
        //初始化数据 将数据添加到容器中
        initData();
        //将数据放入到适配器中
        adapter=new cylMsgAdapter(getActivity(),R.layout.lw_chat_item,mylist);
    ...
    private void initData(){
        lwMsg msg1=new cylMsg("吃饭了吗？",lwMsg.TYPE_RECEIVER);
        mylist.add(msg1);
        lwMsg msg2=new cylMsg("吃了！",lwMsg.TYPE_SEND);
        mylist.add(msg2);
        lwMsg msg3=new cylMsg("什么时候出发？",lwMsg.TYPE_RECEIVER);
        mylist.add(msg3);
    }
}