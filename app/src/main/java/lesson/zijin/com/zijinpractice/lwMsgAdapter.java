...
public class lwMsgAdapter extends ArrayAdapter<lwMsg>{
    private  int resource;

    public lwMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<cylMsg> objects) {
