...
/**
 * Created by hzh on 2017/3/26.
 */

public class HzhMsgAdapter extends ArrayAdapter<HzhMsg>{
    private  int resource;

    public HzhMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<HzhMsg> objects) {
