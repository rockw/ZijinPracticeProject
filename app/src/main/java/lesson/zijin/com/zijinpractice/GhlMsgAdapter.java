...
public class GhlMsgAdapter extends ArrayAdapter<GhlMsg>{
    private  int resource;

    public GhlMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<GhlMsg> objects) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        if (msg.getType()== GhlMsg.TYPE_RECEIVER)//如果它是接收消息 就放左边
        {
            //显示左边 隐藏右边
