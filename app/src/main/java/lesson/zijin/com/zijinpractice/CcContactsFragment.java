...
public class CcContactsFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.cc_contacts,container,false);
        ccListView = (ListView)view.findViewById(R.id.cc_contacts_listview);
