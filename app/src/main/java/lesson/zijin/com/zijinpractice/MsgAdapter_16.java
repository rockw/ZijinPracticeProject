...
public class MsgAdapter_16 extends ArrayAdapter<Msg_16>
{
    private int resourceId;
    public MsgAdapter_16(Context context, int textViewResourceId, List<Msg_16> objects)
    {
