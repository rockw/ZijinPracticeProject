...
public class WyMsgAdapter extends ArrayAdapter<WyMsg>{
    private  int resource;

    public WyMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<WyMsg> objects) {
