...
/**
 * Created by 周良珠 on 2017/5/13.
 */

public class MsgAdapter14 extends ArrayAdapter<Msg_14>{
    private  int resource;

    public MsgAdapter14(@NonNull Context context, @LayoutRes int resource, @NonNull List<Msg_14> objects) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        if (msg.getType()== Msg_14.TYPE_RECEIVER)//如果它是接收消息 就放左边
        {
            //显示左边 隐藏右边
