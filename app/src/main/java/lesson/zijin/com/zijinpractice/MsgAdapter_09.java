...
public class MsgAdapter_09 extends ArrayAdapter<Msg_09> {
    private int resourceId;
    public MsgAdapter_09(Context context, int textViewResourceId, List<Msg_09> objects)
    {
