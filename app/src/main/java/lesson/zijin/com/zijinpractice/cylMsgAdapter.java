...
public class cylMsgAdapter extends ArrayAdapter<cylMsg>{
    private  int resource;

    public cylMsgAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<cylMsg> objects) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        if (msg.getType()== cylMsg.TYPE_RECEIVER)//如果它是接收消息 就放左边
        {
            //显示左边 隐藏右边
