...
public class CjContactsFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.cj_contacts,container,false);
        cjListView = (ListView)view.findViewById(R.id.cj_contacts_listview);
