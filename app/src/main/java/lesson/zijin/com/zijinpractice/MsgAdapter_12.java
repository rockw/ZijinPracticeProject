...
public class MsgAdapter_12 extends ArrayAdapter<Msg_12>
{
    ...
    public MsgAdapter_12(Context context, int textViewResourceId, List<Msg_12> objects)
    {
