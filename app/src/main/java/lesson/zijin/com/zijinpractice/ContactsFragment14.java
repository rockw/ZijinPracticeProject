...
public class ContactsFragment14 extends Fragment{
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.contacts_14,container,false);
        ListView14 = (ListView)view.findViewById(R.id.contacts_14_listview);
